...
.EXAMPLE
   .\Get-PCIDeviceInventory.ps1 -idrac_ip 192.168.0.120 -idrac_username root -idrac_password 'calvin'
#>
...
#Get-PCIDeviceInventory -idrac_ip "192.168.1.100" -idrac_username "root" -idrac_password "calvin"
